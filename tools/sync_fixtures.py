...
def collect_shapes() -> dict[str, Any]:
    ...
    return {
        "_comment": (
            ...
            "replay inputs, including injected failures). Do not edit by hand: run "
            "`make sync-fixtures` after re-recording."
        ),
        "stored_responses_seen": total,
...
def main(argv: list[str] | None = None) -> int:
    ...
    rendered = json.dumps(shapes, indent=2, ensure_ascii=False) + "\n"
    ...
    print(
        ...
        f"({shapes['stored_responses_seen']} stored responses, "
